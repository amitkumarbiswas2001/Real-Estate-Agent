                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('property_category_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.property-categories.index') }}">
                                    ...
                                    @can('property_comment_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.property-comments.index') }}">
                                    ...
                                    @endcan
                                    @can('booking_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.bookings.index') }}">
