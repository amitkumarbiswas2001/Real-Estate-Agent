    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.properties.update", [$property->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $property->slug) }}" required>
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $property->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $property->price) }}" step="0.01" required>
                @if($errors->has('price'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax') ? 'is-invalid' : '' }}" type="number" name="tax" id="tax" value="{{ old('tax', $property->tax) }}" step="0.01" required>
                @if($errors->has('tax'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('beds') ? 'is-invalid' : '' }}" type="number" name="beds" id="beds" value="{{ old('beds', $property->beds) }}" step="1" required>
                @if($errors->has('beds'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('baths') ? 'is-invalid' : '' }}" type="number" name="baths" id="baths" value="{{ old('baths', $property->baths) }}" step="1" required>
                @if($errors->has('baths'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sqft') ? 'is-invalid' : '' }}" type="number" name="sqft" id="sqft" value="{{ old('sqft', $property->sqft) }}" step="1" required>
                @if($errors->has('sqft'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address" required>{{ old('address', $property->address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lankmark') ? 'is-invalid' : '' }}" type="text" name="lankmark" id="lankmark" value="{{ old('lankmark', $property->lankmark) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1" {{ $property->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $property->notes) }}</textarea>
                @if($errors->has('notes'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('other_informations') ? 'is-invalid' : '' }}" name="other_informations" id="other_informations">{{ old('other_informations', $property->other_informations) }}</textarea>
