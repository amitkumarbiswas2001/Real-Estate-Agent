            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-FaqQuestion">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.faqQuestion.fields.featured') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($faqQuestions as $key => $faqQuestion)
                        <tr data-entry-id="{{ $faqQuestion->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $faqQuestion->featured ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $faqQuestion->featured ? 'checked' : '' }}>
                            </td>
                            <td>
