            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-FaqCategory">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.faqCategory.fields.featured') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($faqCategories as $key => $faqCategory)
                        <tr data-entry-id="{{ $faqCategory->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $faqCategory->featured ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $faqCategory->featured ? 'checked' : '' }}>
                            </td>
                            <td>
