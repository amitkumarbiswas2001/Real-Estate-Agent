                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.properties.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tax" id="tax" value="{{ old('tax', '0') }}" step="0.01" required>
                            @if($errors->has('tax'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tax') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="beds" id="beds" value="{{ old('beds', '1') }}" step="1" required>
                            @if($errors->has('beds'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('beds') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="baths" id="baths" value="{{ old('baths', '1') }}" step="1" required>
                            @if($errors->has('baths'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('baths') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sqft" id="sqft" value="{{ old('sqft', '') }}" step="1" required>
                            @if($errors->has('sqft'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sqft') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lankmark" id="lankmark" value="{{ old('lankmark', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="pincode" id="pincode" value="{{ old('pincode', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="other_informations" id="other_informations">{{ old('other_informations') }}</textarea>
