                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bookings.update", [$booking->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $booking->amount) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="paid_amount" id="paid_amount" value="{{ old('paid_amount', $booking->paid_amount) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="payable_amount" id="payable_amount" value="{{ old('payable_amount', $booking->payable_amount) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="booking_form" id="booking_form" value="{{ old('booking_form', $booking->booking_form) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="booking_until" id="booking_until" value="{{ old('booking_until', $booking->booking_until) }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Booking::BOOKING_STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="booking_status_{{ $key }}" name="booking_status" value="{{ $key }}" {{ old('booking_status', $booking->booking_status) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="document_number" id="document_number" value="{{ old('document_number', $booking->document_number) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="document_verified" id="document_verified" value="1" {{ $booking->document_verified || old('document_verified', 0) === 1 ? 'checked' : '' }}>
