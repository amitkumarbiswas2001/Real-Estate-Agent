...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa', 'admin']], function () {
    ...
    // Property Comments
    Route::delete('property-comments/destroy', 'PropertyCommentController@massDestroy')->name('property-comments.massDestroy');
    Route::resource('property-comments', 'PropertyCommentController');
    ...
    Route::post('property-categories/media', 'PropertyCategoryController@storeMedia')->name('property-categories.storeMedia');
    Route::post('property-categories/ckmedia', 'PropertyCategoryController@storeCKEditorImages')->name('property-categories.storeCKEditorImages');
