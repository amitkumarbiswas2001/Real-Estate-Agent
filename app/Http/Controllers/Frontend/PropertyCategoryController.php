...
class PropertyCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.propertyCategories.index', compact('propertyCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.propertyCategories.create');
    }
    ...
    public function store(StorePropertyCategoryRequest $request)
    {
        ...
        return redirect()->route('frontend.property-categories.index');
    }
    ...
    public function edit(PropertyCategory $propertyCategory)
    {
        ...
        return view('frontend.propertyCategories.edit', compact('propertyCategory'));
    }
    ...
    public function show(PropertyCategory $propertyCategory)
    {
        ...
        return view('frontend.propertyCategories.show', compact('propertyCategory'));
    }
