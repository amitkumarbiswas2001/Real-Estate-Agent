...
class PropertyCommentController extends Controller
{
    public function index()
    {
        ...
        return view('admin.propertyComments.index', compact('propertyComments'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.propertyComments.create', compact('users'));
    }
    ...
    public function store(StorePropertyCommentRequest $request)
    {
        ...
        return redirect()->route('admin.property-comments.index');
    }
    ...
    public function edit(PropertyComment $propertyComment)
    {
        ...
        return view('admin.propertyComments.edit', compact('users', 'propertyComment'));
    }
    ...
    public function show(PropertyComment $propertyComment)
    {
        ...
        return view('admin.propertyComments.show', compact('propertyComment'));
    }
